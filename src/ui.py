...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QRect(10, 10, 571, 301))
        self.translateBtn = QPushButton(self.widget)
        self.translateBtn.setObjectName(u"translateBtn")
        self.translateBtn.setGeometry(QRect(240, 270, 75, 24))
        ...
        self.checkEnableAIBox = QCheckBox(self.widget)
        self.checkEnableAIBox.setObjectName(u"checkEnableAIBox")
        self.checkEnableAIBox.setGeometry(QRect(110, 273, 133, 20))
        self.aiModelComboBox = QComboBox(self.widget)
        self.aiModelComboBox.setObjectName(u"aiModelComboBox")
        self.aiModelComboBox.setEnabled(False)
        self.aiModelComboBox.setGeometry(QRect(460, 240, 101, 22))
        self.label_13 = QLabel(self.widget)
        self.label_13.setObjectName(u"label_13")
        self.label_13.setGeometry(QRect(400, 243, 54, 16))
        self.batchSizeComboBox = QComboBox(self.widget)
        self.batchSizeComboBox.setObjectName(u"batchSizeComboBox")
        self.batchSizeComboBox.setGeometry(QRect(310, 240, 71, 22))
        self.label_14 = QLabel(self.widget)
        self.label_14.setObjectName(u"label_14")
        self.label_14.setGeometry(QRect(20, 240, 301, 20))
        self.aiRunningModeComboBox = QComboBox(self.widget)
        self.aiRunningModeComboBox.setObjectName(u"aiRunningModeComboBox")
        self.aiRunningModeComboBox.setEnabled(False)
        self.aiRunningModeComboBox.setGeometry(QRect(460, 270, 101, 22))
        self.label_15 = QLabel(self.widget)
        self.label_15.setObjectName(u"label_15")
        self.label_15.setGeometry(QRect(350, 273, 111, 16))
        self.widget_2 = QWidget(self.centralwidget)
        self.widget_2.setObjectName(u"widget_2")
        self.widget_2.setGeometry(QRect(10, 310, 571, 271))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkEnableAIBox.setText(QCoreApplication.translate("MainWindow", u"Enale AI Translate", None))
        self.label_13.setText(QCoreApplication.translate("MainWindow", u"AI Model", None))
        self.label_14.setText(QCoreApplication.translate("MainWindow", u"(set a lower value if out of memory ) ai_batch_size:", None))
        self.label_15.setText(QCoreApplication.translate("MainWindow", u"AI Running Mode", None))
#if QT_CONFIG(tooltip)
        ...
        self.versionLabel.setText(QCoreApplication.translate("MainWindow", u"Version 2.1.1", None))
