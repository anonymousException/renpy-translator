...
class Ui_EngineDialog(object):
    def setupUi(self, EngineDialog):
        ...
        self.keyEdit.setGeometry(QRect(240, 68, 331, 20))
        ...
        self.baseUrlEdit.setGeometry(QRect(160, 270, 411, 20))
