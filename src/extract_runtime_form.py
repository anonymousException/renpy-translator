...
class MyExtractionRuntimeForm(QDialog, Ui_ExtractionRuntimeDialog):
                        ...
                        if not os.path.isfile(target):
                            ...
                            for i in value:
                                ...
                                if who is not None:
                                    ...
                                    who =''
                                f.write(f'    # {who}"{what}"\n')
                                if self.emptyCheckBox.isChecked():
                                    f.write(f'    {who}""\n')
                                else:
                                    f.write(f'    {who}"{what}"\n')
    ...
    def select_file(self):
        file, filetype = QFileDialog.getOpenFileName(self,
                                                     QCoreApplication.translate('ExtractionRuntimeDialog', 'select the game file you want to extract', None),
                                                     '',
                                                     "Game Files (*.exe)")
