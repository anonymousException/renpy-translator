...
class Ui_LocalGlossaryDialog(object):
    def setupUi(self, LocalGlossaryDialog):
        ...
        LocalGlossaryDialog.resize(694, 554)
        ...
        self.prevButton.setMinimumSize(QSize(100, 0))
        ...
        self.nextButton.setMinimumSize(QSize(100, 0))
        ...
        self.selectFileBtn.setMinimumSize(QSize(100, 40))
        ...
        self.maxPageRowsButton.setGeometry(QRect(590, 50, 75, 20))
