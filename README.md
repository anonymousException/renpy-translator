...
You can download from [https://github.com/anonymousException/renpy-translator/releases/tag/v2.1.2-alpha](https://github.com/anonymousException/renpy-translator/releases/tag/v2.1.2-alpha)
