...
你可以通过 [https://github.com/anonymousException/renpy-translator/releases/tag/v2.1.5-alpha](https://github.com/anonymousException/renpy-translator/releases/tag/v2.1.5-alpha) 下载 AI 版本
